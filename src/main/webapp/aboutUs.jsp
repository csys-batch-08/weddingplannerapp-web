...
<body>
	<nav>
		...
		<form action="filterCity" method="post">
			<input type="text" name="search" class="search"> <a
				href="FilterCity.jsp"><button class="button">search</button></a>
		</form>
	...
	<div class="section">
		<div class="container">
			<div class="content-section">
				...
				<div class="social">
					<a href=""><em class="fab fa-facebook-f"></em></a> <a href=""><em
						class="fab fa-twitter"></em></a> <a href=""><em
