	...
	<div class="form1">
		<div class="form2">
			<form action="rechargewallet" method="post">
				...
				<br> <label for="emailid">Email address</label><br> 
				<input type="email" class="text" name="email" 
				pattern="[a-z0-9]+[@][a-z]+[.][a-z]+{8,15}" id="emailid" required><br>
				<br> <label for="cardnumber">Card Number</label><br> <input
					type="text" class="text" name="cardnumber" pattern="[1-9]{16}"
					id="cardnumber" required><br>
				<br> <label for="cvv">CVV</label><br> <input type="text"
					class="text" name="cvv" pattern="[1-9]{3}" id="cvv" required><br>
				<br> <label for="Amount">Amount</label><br> <input
					type="text" class="text" name="amount" pattern="[1-9][0-9]+"
					maxlength="5" id="Amount" required><br>
				<br>
